...
REQUIRED_COLUMNS = {
    ...
    "yougile_workspaces": {"connection_id", "external_id", "synced_at"},
    "yougile_projects": {"connection_id", "workspace_id", "external_id", "synced_at"},
    "yougile_boards": {"team_id", "connection_id", "project_id", "external_id"},
    "yougile_columns": {"board_id", "external_id", "synced_at"},
    "agent_recommendations": {"company_id", "team_id", "kind", "status"},
