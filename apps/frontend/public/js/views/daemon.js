  ...
  async function render() {
    ...
    content.innerHTML = `<div class="grid g2">
      <div class="card card-pad"><div class="card-head"><div class="card-title">Установка</div></div>
        <p class="dim">Windows-агент работает в трее, записывает звук созвона и отправляет его на обработку.</p>
        <a class="btn btn-primary mt-16" href="/downloads/GreyCardinalAgent-x64.msi?v=0.6.2" download>Скачать MSI для Windows</a>
