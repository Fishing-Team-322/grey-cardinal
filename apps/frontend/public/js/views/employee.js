...
export default async function employeeView(root) {
  ...
  content.innerHTML = `
    <div class="grid g4">
      ...
      <div class="stat"><div class="stat-label">Desktop Agent</div><div class="stat-value" style="font-size:20px">${agents.agents.some((agent) => agent.online) ? "Online" : "Offline"}</div></div>
    </div>
