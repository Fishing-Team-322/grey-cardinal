...
async def test_max_daily_suppresses():
    config = AppConfig(reminder_max_daily_per_user=3, reminder_quiet_hours_start="22:00",
...
async def test_min_interval_suppresses():
    config = AppConfig(reminder_min_interval_minutes=120, reminder_max_daily_per_user=10,
                       reminder_quiet_hours_start="22:00", reminder_quiet_hours_end="09:00")
...
async def test_allowed_when_within_limits():
    config = AppConfig(reminder_min_interval_minutes=120, reminder_max_daily_per_user=3,
                       reminder_quiet_hours_start="22:00", reminder_quiet_hours_end="09:00")
...
async def test_group_recipient_only_checks_quiet_hours():
    config = AppConfig(reminder_max_daily_per_user=0, reminder_quiet_hours_start="22:00",
                       reminder_quiet_hours_end="09:00")
